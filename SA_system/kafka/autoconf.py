...
def pmacctd_start():
	...
	if nums > 2:
		...
		pmacctd_shutdown()
	cmd_start = " pmacctd -f /home/minuser/xin777/kafka/librdkafka/pmacct-master/pmacctd2.conf >/dev/null"
	try:
		os.system(cmd_start)
...
def kafka_start_zookeeper():
	...
	cmd_start_zookeeper = "/home/minuser/xin777/kafka/kafka_2.13-2.5.0/bin/zookeeper-server-start.sh /home/minuser/xin777/kafka/kafka_2.13-2.5.0/config/zookeeper.properties >/dev/null"
	try:
...
def kafka_start_server():
	...
	cmd_start_server = "/home/minuser/xin777/kafka/kafka_2.13-2.5.0/bin/kafka-server-start.sh /home/minuser/xin777/kafka/kafka_2.13-2.5.0/config/server.properties >/dev/null"
	try:
...
def test_kafka():
	...
	try:
		...
		print "ERROR: ",e
		print "=======================================\nplease run the command : \nsudo /home/minuser/xin777/kafka/kafka_2.13-2.5.0/bin/kafka-server-start.sh /home/minuser/xin777/kafka/kafka_2.13-2.5.0/config/server.properties\n====================================\n\n\n"
