...
if __name__ == "__main__":
	...
	parser.add_argument('-itv', '--interval', default=120, help="set the userFrequency detection's interval, default 120s", type=int)
	...
	t_userFreq = threading.Thread(name="user frequency", target=userFrequency.run, args=(args.interval,))
